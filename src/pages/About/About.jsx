        ...
        <div className='about-body'>
            <div className="about-banner">
                <div className="container">
                    ...
                    <h3 className='page-sub'>Learnify Helping you to learn with an ease</h3>
                </div>
            </div>
            <div className="container text-center">
                ...
                <div className="overlap">
                    <div className="content">
                        <h5>5000+</h5>
                        <p className='mt-2 star'><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i></p>
                        <h5>STUDENTS LOVED US</h5>
                    </div>
                </div>
                <p className='about-p'>There are many variations of passages of lorem ipsum available, but the majority have suffered alteration in some form, by injected humour words which don't look even slightly believable. Lorem Ipsn gravida nibh vel velit auctor aliquetn auci elit cons.</p>
                <button className='btn about-btn'>Start Learninf Now</button>
                </div>
                {/* team here  */}
                <div className="team pt-5">
                    ...
                    <div className="cards">
                        ...
                        <div className="card align-items-center">
                        <div className="team-img">
                                <img src={team4} className="card-img-top team-img" alt="..." />
                            </div>
                            <div className="card-body">
                                <h5 className="card-title">Christina Newman</h5>
                                <p className="card-text">Teacher</p>
