        ...
        <div className="home-body">
            ...
            <div className="banner">
                <div className="container text-center">
                    <h1>
                        Helping you to make yourself an expert in programming
                    </h1>
            ...
            <div className="container pb-5">
                ...
                <div className="text-center pt-4">
                    <Link to="/courses">
                        <button className="btn course-btn">All Courses</button>
                    </Link>
                </div>
                ...
                <div className="feedback text-center py-5">
                    ...
                    <div className="cards">
                        <div className="card text-center">
                            <div className="card-body">
                                <p className="card-text">
                                    ...
                                    everything to be organized and neat. Then,
                                    I'll be able to make things right and shine.
                            ...
                            <div className="d-flex feed-box">
                                <img
                                    src={person1}
                                    className="card-img-top feed-img"
                                    alt="..."
                                />
                            </div>
                        </div>
                        <div className="card text-center">
                            <div className="card-body">
                                <p className="card-text">
                                    I am free to learn at my own pace, follow my
                                    own schedule and choose the subject I want
                                    to learn from the syllabus. Great study
                        ...
                        <div className="card text-center">
                            <div className="card-body">
                                <p className="card-text">
                                    ...
                                    proficiency and MaxCoach is my best choice.
                                    Their tutors are smart and professional when
